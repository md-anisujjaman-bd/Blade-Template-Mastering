    ...
    <div class="container mx-auto px-4">
        <div class="grid md:grid-cols-4 gap-8">
            ...
            <div>
                ...
                <ul class="space-y-2">
                    <li><a href="{{ route('categories') }}" class="text-gray-400 hover:text-white transition">Web Development</a></li>
                    <li><a href="{{ route('categories') }}" class="text-gray-400 hover:text-white transition">Artificial Intelligence</a></li>
                    <li><a href="{{ route('categories') }}" class="text-gray-400 hover:text-white transition">Cloud Computing</a></li>
                    <li><a href="{{ route('categories') }}" class="text-gray-400 hover:text-white transition">Cybersecurity</a></li>
                </ul>
            </div>
