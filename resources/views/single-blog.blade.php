...
exports.handler = async (event) => {
    ...
    return response;
                    ...
                    <p class="text-gray-700 mb-5 leading-relaxed">The Jamstack architecture (JavaScript, APIs, and Markup) has proven its value for building fast, secure, and scalable websites. In 2023, we're seeing:</p>
